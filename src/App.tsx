...
import { Pagination } from "./components/PaginationJest";
    ...
    <>
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          >
            <Button color="success" variant="text" size="large" icon="Add">
              人生重來鈕
            </Button>
            <Button color="success" variant="text" size="medium" icon="Add">
              人生重來鈕
            </Button>
            <Button color="success" variant="text" size="small" icon="Add">
              人生重來鈕
            </Button>
          </div>
        </section>
        <section style={{ display: "flex", gap: "8px" }}>
          <h6 style={{ fontSize: "24px", margin: 0 }}>Badge Section</h6>
          <label
            style={{
          ...
          <Badge color="error" badgeContent={100} variant="standard">
            <Button text="Badge 2" variant="contained" color="primary" />
          </Badge>
        </section>
        {/* <section>
